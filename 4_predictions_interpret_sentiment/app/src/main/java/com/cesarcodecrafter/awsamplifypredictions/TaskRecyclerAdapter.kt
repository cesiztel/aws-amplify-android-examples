...
class TaskRecyclerAdapter(private val tasks: List<Task>, private val taskHolderListener: (Int) -> Unit) : RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
    ...
    class TaskItemHolder(v: View) : RecyclerView.ViewHolder(v) {
        ...
        fun bind(position: Int, task: Task, clickListener: (Int) -> Unit) {
            this.task = task
